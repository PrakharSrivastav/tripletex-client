...
// WithBody adds the body to the post division params
func (o *PostDivisionParams) WithBody(body *models.Division) *PostDivisionParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post division params
func (o *PostDivisionParams) SetBody(body *models.Division) {
	o.Body = body
}
