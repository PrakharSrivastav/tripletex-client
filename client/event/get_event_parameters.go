...
// WithFields adds the fields to the get event params
func (o *GetEventParams) WithFields(fields *string) *GetEventParams {
	o.SetFields(fields)
	return o
}

// SetFields adds the fields to the get event params
func (o *GetEventParams) SetFields(fields *string) {
	o.Fields = fields
}
